...
[![Build Status](https://travis-ci.org/antoinereyt/ex_json_schema.svg?branch=validation-errors)](https://travis-ci.org/jonasschmidt/ex_json_schema) [![Hex.pm](http://img.shields.io/hexpm/v/ex_json_schema.svg)](https://hex.pm/packages/ex_json_schema) [![Hex.pm](http://img.shields.io/hexpm/l/ex_json_schema.svg)](LICENSE)
